...
<html>
    ...
    <body>
            ...
            <div class = "container" style = "margin-top: 10px">
                ...
                <div>
                    <ul class = "nav navbar-nav topnav-right">
                        <li class = "nav-item topnav active"><a href = "contact.php"><span class="glyphicon glyphicon-envelope"></span> Contact</a></li>                            
        ...
        <div class = "container" align = "center" width = 40% >
            <h3 style = "font-size: 30px; text-decoration:underline;"><strong>CONTACT US</strong></h3>
            <div class = "form-element">
                <form action = "actionpage.php" method = "post">
                    ...
                    <br>
                    <textarea id = "query" placeholder = "Enter query" rows="4" cols="100"></textarea>
                    <br>
